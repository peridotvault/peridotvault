    ...
    return (
        <div className="sm-scope w-full h-full">
            ...
            >
                ...
                >
                    <Link href="/" className="text-2xl flex items-center gap-2" aria-label="Logo">
                        <img src="/Logo-full.png" className="h-6" alt="PeridotVault logo" draggable={false} />
                        <div className={`${open ? "text-black" : "text-white"} duration-300`}>
